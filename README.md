...
<h3>This aplication is based on hand gesture recognition, you can train your own hand gesture, to be precised 5 sign via Tensorflow and the CNN that i created.For hand tracking i'm using Mediapipe and OpenCV for camera.For each sign, it take 200 photos(see the data_example directory).</h3>
